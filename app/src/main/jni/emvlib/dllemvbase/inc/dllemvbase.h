...
#define RLT_EMV_PPSE_REV_6A82		38	//美运ppse返回6a82要走aid列表选择法
...
typedef void (*EMVBASE_DealSred)(unsigned int cmd, unsigned int dataInLen, unsigned char* dataIn, unsigned int* dataOutLen, unsigned char* dataOut);
...
extern unsigned char EMVBase_FinalSelectedApp(EMVBase_UnionStruct *tempEMVBase_UnionStruct);
extern unsigned char EMVBase_InitialApp(EMVBase_UnionStruct *tempEMVBase_UnionStruct);
