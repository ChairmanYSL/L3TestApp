...
extern unsigned char emvbase_avl_checkiftagempty(unsigned char *tag);
extern unsigned char emvbase_avl_checkiftagpresent(unsigned char *tag);
extern unsigned char emvbase_avl_checkiftagnotpresent(unsigned char *tag);
extern unsigned char emvbase_avl_checkiftagknown(unsigned char *tag);
