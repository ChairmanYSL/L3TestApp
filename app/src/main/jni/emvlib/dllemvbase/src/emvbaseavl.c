...
emvbase_avl_create (emvbase_avl_comparison_func *compare, void *param,
            struct emvbase_libavl_allocator *allocator)
{
...
void *
emvbase_avl_malloc (struct emvbase_libavl_allocator *allocator, unsigned int size)
{
  void *pmalloc;
